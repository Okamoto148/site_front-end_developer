const Pagina9 = { 
    ...
    methods:{
      ...
      getPersonagens(){
        axios
          .get("https://swapi.dev/api/people/?page=9&format=json")
          .then((res) => {
      ...
      <ul class="nav nav-pills header2">
        ...
        <li class="nav-item"><router-link to="/" class="nav-link" style="color: red;">Próxima</router-link></li>
        <li class="nav-item"><router-link to="/pagina8" class="nav-link" style="color: red;">Anterior</router-link></li>           

      </ul>
    </header>
          <h1 class="pagina">Página 9</h1>
