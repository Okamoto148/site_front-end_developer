const Pagina3 = { 
  ...
  methods:{
    ...
    getPersonagens(){
      axios
        .get("https://swapi.dev/api/people/?page=3&format=json")
        .then((res) => {
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 header">
          ...
          <ul class="nav nav-pills header2">
            ...
            <li class="nav-item"><router-link to="/pagina4" class="nav-link" style="color: red;">Próxima</router-link></li>
            <li class="nav-item"><router-link to="/pagina2" class="nav-link" style="color: red;">Anterior</router-link></li>           

          </ul>
        </header>
        <h1 class="pagina">Página 3</h1>
