const Pagina4 = { 
    ...
    methods:{
      ...
      getPersonagens(){
        axios
          .get("https://swapi.dev/api/people/?page=4&format=json")
          .then((res) => {
      ...
      <ul class="nav nav-pills header2">
        ...
        <li class="nav-item"><router-link to="/pagina5" class="nav-link" style="color: red;">Próxima</router-link></li>
        <li class="nav-item"><router-link to="/pagina3" class="nav-link" style="color: red;">Anterior</router-link></li>           

      </ul>
    </header>
          <h1 class="pagina">Página 4</h1>
